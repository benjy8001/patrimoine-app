...
class AssetsSheet implements FromCollection, WithTitle, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithColumnFormatting
{
    ...
    public function map($asset): array
    {
        ...
        return [
            ...
            round($asset->gainLoss(), 2),
            round($asset->gainLossPercent(), 2),
